...
if (isset($_POST["submit"])) {
   ...
   {   
      if (isset($_FILES['file']) && $_FILES['file']['error'] === UPLOAD_ERR_OK) {
          ...
          $errorMsg=$signup->updateProduct($productID, $productName, $price, $image);
      } 
      else 
      {
   ...
   else
   {
      ...
      window.location.href = 'admin_product_details_edit.php';
                           ...
                           <div class="white_shd full margin_bottom_30">
                              ...
                              <div class="full price_table padding_infor_info">
                                 <div class="row">
                                    ...
                                    <!-- profile image -->
                                    <form action="admin_product_details_edit.php" method="post" enctype="multipart/form-data">
                                    <div class="col-lg-12">
                                       <div class="full dis_flex center_text">
                                          <div class="profile_img">
                                             <img width="180" class="rounded-circle" src="../Mainpage/assets/img/Product/<?php echo $product["image"]?>" alt="#" /><br>
                                             <!-- File upload button -->
