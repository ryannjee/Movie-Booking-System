...
if (isset($_POST["submit"])) {
   ...
   $packageDetail = !empty($_POST["packageDetail"]) ? $_POST["packageDetail"] : "";
    ...
    {
        $Login->updatePackageAdmin($packageID,$packageName, $packageDetail, $keyword) ;
    }
                           ...
                           <div class="white_shd full margin_bottom_30">
                              ...
                              <div class="full price_table padding_infor_info">
                                 <div class="row">
                                    ...
                                    <!-- profile image -->
                                    <form action="admin_package_details_edit.php" method="post" >
                                    <div class="col-lg-12">
                                       <div class="full dis_flex center_text">
                                          ...
                                          <div class="profile_contant">
                                             ...
                                             <input type="text" name="packageName" value="<?php echo $user["packageName"]; ?>"><br>
                                             <?php                                              
                                             if ($packageNameErr == "") {
                                             ...
                                             <input type="text" name="packageDetail" value="<?php echo $user["packageDetail"]; ?>"><br>
                                             <?php
                                             if ($packageDetailErr == "") {
                                                // If the error is empty, this row does not appear
                                             ...
                                             <input type="text" name="keyword" value="<?php echo $user["keyword"]; ?>"><br>
                                             <?php
                                             if ($keywordErr == "") {
                                                // If the error is empty, this row does not appear
