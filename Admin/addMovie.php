...
if (isset($_POST["submit"])) {
   ...
   {   
      if (isset($_FILES['file']) && $_FILES['file']['error'] === UPLOAD_ERR_OK) {
          ...
          $errorMsg=$signup->UploadMovie($movieName, $Synopsis, $Director, $Starring, $RunningTime, $Genre, $image, $status, $Trailers, $Fee, $Date, $package, $language) ;
      } 
      else 
      {
                                    ...
                                    <div class="col-lg-12">
                                       <div class="full dis_flex center_text">
                                          <div class="profile_img">
                                             <img width="180" class="rounded-circle" src="../Mainpage/assets/img/Movie/cinema-background-with-movie-objects_1823384.jpg" alt="#" /><br>
                                             <!-- File upload button -->
                                        ...
                                        <div class="profile_contant">
                                            ...
                                            <textarea name="Synopsis" rows="4" cols="50" placeholder="Enter the synopsis"></textarea><br>                                            
                                            ...
                                            <input type="text" name="RunningTime" ><br>     
                                            ...
                                            <input type="text" name="Trailers"><br>
