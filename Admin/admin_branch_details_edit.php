...
if (isset($_POST["submit"])) {
    ...
    {
        $Login->updatebranchAdmin($branchID,$branchName, $phoneNumber, $address);
    }
                           ...
                           <div class="white_shd full margin_bottom_30">
                              ...
                              <div class="full price_table padding_infor_info">
                                 <div class="row">
                                    ...
                                    <!-- profile image -->
                                    <form action="admin_branch_details_edit.php" method="post" >
                                    <div class="col-lg-12">
                                       <div class="full dis_flex center_text">
                                          ...
                                          <div class="profile_contant">
                                             ...
                                             <input type="text" name="branchName" value="<?php echo $user["branchName"]; ?>"><br>
                                             <?php                                              
                                             if ($fnameErr == "") {
