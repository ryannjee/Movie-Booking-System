...
if (isset($_POST["submit"])) {
   ...
   if (empty($fnameErr) && empty($lnameErr) && empty($phoneErr) && empty($mailErr) && empty($genderErr)) {
      ...
      if (isset($_FILES['file']) && $_FILES['file']['error'] === UPLOAD_ERR_OK) {
          ...
          if($emailChan!=$email)
          {
            $errorMsg = $Login->isEmailExistsAdmin($userID, $fname, $lname, $phoneNo, $gender, $image,$email); 
          }
          else
          {
            $Login->updateuserdetailsAdmin($userID, $fname, $lname, $phoneNo, $gender, $image);
                           ...
                           <div class="white_shd full margin_bottom_30">
                              ...
                              <div class="full price_table padding_infor_info">
                                 <div class="row">
                                    ...
                                    <!-- profile image -->
                                    <form action="admin_user_details_edit.php" method="post" enctype="multipart/form-data">
                                    <div class="col-lg-12">
