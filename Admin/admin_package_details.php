<?php
   ...
   $branchID = isset($_SESSION["packageID"]) ? $_SESSION["packageID"] : "";

   if(isset($_POST["edit"]))
   {
      $_SESSION["packageID"]=$_POST["packageID"];
      header("location:admin_package_details_edit.php");
   }
   ...
   if(isset($_POST["delete"]))
   {
      ...
      $Login-> deletepackageID($packageID);
      echo "<script>
      alert('Delete successfully!!!');
      window.location.href = 'admin_package_details.php';
...
$total_query = "SELECT COUNT(*) as total FROM package";
                        ...
                        <div class="col-md-12">
                           <div class="page_title">
                              <div class="search">
                                 ...
                                 <form action="admin_package_details.php" method="POST">
                                       ...
                                       <button class="search-button" style="float: right; margin-right: 15px;" name="add"><a href="addPackage.php" style="color: white;">Add Package</a></button> 
                                    </form>                
                                 </div>
                              </div>
                           </div>
                              ...
                              <table class="table table-striped">
                                  <thead>
                                    <tr>
                                       ...
                                       <tbody>
                                       <?php 
                                                $sql = "SELECT * FROM package LIMIT $offset, $records_per_page";
                                                ...
                                                {                                                    
                                                    ...
                                                    if ($filter == "packageID") 
                                                    {
                                                        ...
                                                        $sql = "SELECT * FROM package WHERE packageID = '$title' LIMIT $offset, $records_per_page";
                                                            if ($title == "") 
                                                            {
                                                                $sql = "SELECT * FROM package LIMIT $offset, $records_per_page";
                                                            }
                                                    ...
                                                    {
                                                        // Add appropriate conditions to the query based on the filter and key values
                                                        $sql = "SELECT * FROM package WHERE packageName like '%$title%' LIMIT $offset, $records_per_page";
                                                            if ($title == "") 
                                                            {
                                                                $sql = "SELECT * FROM package LIMIT $offset, $records_per_page";
                                                            }
                                       ...
                                       <form action="admin_package_details.php" method="post">
                                       <?php
                                       while($packageDetail = mysqli_fetch_assoc($result)) {                                           
                                       ?>
                                       <tr>
                                          <form action="admin_package_details.php" method="post">
                                             <td><?php echo $packageDetail["packageID"]?></td>
                                             <td><?php echo $packageDetail["packageName"]?></td>   
                                             <td><?php echo $packageDetail["packageDetail"]?></td>
                                             <td><?php echo $packageDetail["keyword"]?></td>   
                                             <input type="hidden" value="<?php echo $packageDetail["packageID"]?>" name="packageID">      
