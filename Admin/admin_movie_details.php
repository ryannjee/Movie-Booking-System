<?php
   ...
   if(isset($_POST["edit"]))
   {
      ...
      header("location:admin_movie_details_edit.php");
   }
   ...
   if(isset($_POST["delete"]))
   {
      ...
      $Login-> deteleMovie($movieID);
      echo "<script>
      alert('Delete successfully!!!');
      window.location.href = 'admin_movie_details.php';
...
$total_query = "SELECT COUNT(*) as total FROM movie";
                        ...
                        <div class="col-md-12">
                           <div class="page_title">
                              <div class="search">
                                 ...
                                 <form action="admin_movie_details.php" method="POST">
                                       ...
                                       <button class="search-button" style="float: right; margin-right: 15px;" name="add"><a href="addMovie.php" style="color: white;">Add Movie</a></button> 
                                    </form>                
                                 </div>
                              </div>
                           </div>
                              ...
                              <table class="table table-striped">
                                  <thead>
                                    <tr>
                                       ...
                                       <th>movieID </th>
                                       <th>movieName</th>
                                       <th style="width: 300px;">Synopsis</th>
                                       <th>Director</th>
                                       <th>Starring</th>
                                       <th>RunningTime</th>
                                       <th>Genre </th>
                                       ...
                                       <tbody>
                                       <?php 
                                                $sql = "SELECT * FROM movie LIMIT $offset, $records_per_page";
                                                ...
                                                {                                                    
                                                    ...
                                                    if ($filter == "movieName") 
                                                    {
                                                        ...
                                                        $sql = "SELECT * FROM movie WHERE movieName Like '%$title%' LIMIT $offset, $records_per_page";
                                                            if ($title == "") 
                                                            {
                                                                $sql = "SELECT * FROM movie LIMIT $offset, $records_per_page";
                                                            }
                                                    ...
                                                    {
                                                        // Add appropriate conditions to the query based on the filter and key values
                                                        $sql = "SELECT * FROM movie WHERE Director LIKE '%$title%' LIMIT $offset, $records_per_page";
                                                            if ($title == "") 
                                                            {
                                                                $sql = "SELECT * FROM movie  LIMIT $offset, $records_per_page";
                                                            }
                                                    ...
                                                    else if ($filter == "Starring") 
                                                    {
                                                        // Add appropriate conditions to the query based on the filter and key values
                                                        $sql = "SELECT * FROM movie WHERE Starring LIKE '%$title%' LIMIT $offset, $records_per_page";
                                                            if ($title == "") 
                                                            {
                                                                $sql = "SELECT * FROM movie  LIMIT $offset, $records_per_page";
                                                            }
                                                    ...
                                                    else if ($filter == "RunningTime") 
                                                    {
                                                      
                                                        // Add appropriate conditions to the query based on the filter and key values
                                                        $sql = "SELECT * FROM movie WHERE RunningTime LIKE '%$title%' LIMIT $offset, $records_per_page";
                                                            if ($title == "") 
                                                            {
                                                                $sql = "SELECT * FROM movie  LIMIT $offset, $records_per_page";
                                                            }
                                                    ...
                                                    else if ($filter == "Genre") 
                                                    {
                                                        ...
                                                        // Add appropriate conditions to the query based on the filter and key values
                                                        $sql = "SELECT * FROM movie WHERE Genre LIKE '%$title%'  LIMIT $offset, $records_per_page";
                                                            if ($title == "") 
                                                            {
                                                                $sql = "SELECT * FROM movie  LIMIT $offset, $records_per_page";
                                                            }
                                                    ...
                                                    else if ($filter == "status") 
                                                    {
                                                        ...
                                                        // Add appropriate conditions to the query based on the filter and key values
                                                        $sql = "SELECT * FROM movie WHERE status LIKE '%$title%' LIMIT $offset, $records_per_page";
                                                            if ($title == "") 
                                                            {
                                                                $sql = "SELECT * FROM movie LIMIT $offset, $records_per_page";
                                                            }
                                                    ...
                                                    else if ($filter == "Fee") 
                                                    {
                                                        ...
                                                        // Add appropriate conditions to the query based on the filter and key values
                                                        $sql = "SELECT * FROM movie WHERE Fee LIKE '%$title%' LIMIT $offset, $records_per_page";
                                                            if ($title == "") 
                                                            {
                                                                $sql = "SELECT * FROM movie LIMIT $offset, $records_per_page";
                                                            }
                                                    ...
                                                    else if ($filter == "Date") 
                                                    {
                                                        ...
                                                        // Add appropriate conditions to the query based on the filter and key values
                                                        $sql = "SELECT * FROM movie WHERE Date LIKE '%$title%' LIMIT $offset, $records_per_page";
                                                            if ($title == "") 
                                                            {
                                                                $sql = "SELECT * FROM movie LIMIT $offset, $records_per_page";
                                                            }
                                                    ...
                                                    else if ($filter == "package") 
                                                    {
                                                        ...
                                                        // Add appropriate conditions to the query based on the filter and key values
                                                        $sql = "SELECT * FROM movie WHERE package LIKE '%$title%' LIMIT $offset, $records_per_page";
                                                            if ($title == "") 
                                                            {
                                                                $sql = "SELECT * FROM movie LIMIT $offset, $records_per_page";
                                                            }
                                                    ...
                                                    else if ($filter == "language") 
                                                    {
                                                        ...
                                                        // Add appropriate conditions to the query based on the filter and key values
                                                        $sql = "SELECT * FROM movie WHERE language LIKE '%$title%' LIMIT $offset, $records_per_page";
                                                            if ($title == "") 
                                                            {
                                                                $sql = "SELECT * FROM movie LIMIT $offset, $records_per_page";
                                                            }
                                       ...
                                       <tr>
                                          <form action="admin_movie_details.php" method="post">
                                          <td> <img class="img-responsive rounded-circle" src="../Mainpage/assets/img/Movie/<?php echo $userInfo["image"]?>"></td>                                        
                                             <td><?php echo $userInfo["movieID"]?></td>
                                             <td><?php echo $userInfo["movieName"]?></td>
                                             <td><?php echo $userInfo["Synopsis"]?></td>
                                             <td><?php echo $userInfo["Director"]?></td>
                                             <td><?php echo $userInfo["Starring"]?></td>                                               
                                             <td><?php echo $userInfo["RunningTime"]?></td>   

                                             <td><?php echo $userInfo["Genre"]?></td>
                                             <td><?php echo $userInfo["status"]?></td>
                                             <td><?php echo $userInfo["Trailers"]?></td>
                                             <td><?php echo $userInfo["Fee"]?></td>
                                             <td><?php echo $userInfo["Date"]?></td>                                               
                                             <td><?php echo $userInfo["package"]?></td>                                            
                                             <td><?php echo $userInfo["language"]?></td>
                                             <input type="hidden" value="<?php echo $userInfo["movieID"]?>" name="movieID">      
