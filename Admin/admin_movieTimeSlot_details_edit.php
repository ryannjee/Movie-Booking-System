...
if (isset($_POST["submit"])) {
    ...
    $packageID1 = isset($_SESSION["packageID"]) ? $_SESSION["packageID"] : "";
    $movieID1 = isset($_SESSION["movieID"]) ? $_SESSION["movieID"] : "";
    $branchID1 = isset($_SESSION["branchID"]) ? $_SESSION["branchID"] : "";
    $dateOfmovie1 = isset($_SESSION["dateOfmovie"]) ? $_SESSION["dateOfmovie"] : "";
    $timeOfmovie1 = isset($_SESSION["timeOfmovie"]) ? $_SESSION["timeOfmovie"] : "";    
    ...
    if (!empty($packageID) && !empty($movieID) && !empty($branchID) && !empty($dateOfmovie) && !empty($timeOfmovie)) 
   {
      ...
      if($Login->updateRoom1($TimeSlotID, $room, $dateOfmovie, $timeOfmovie,$branchID) )
      {

         if($Login->updatePackage_movie($TimeSlotID,$packageID,$movieID, $branchID, $dateOfmovie, $timeOfmovie,$packageID1,$movieID1,$branchID1,$dateOfmovie1,$timeOfmovie1))
         {
            $email = new email();
            $userEmails = $Login->getBookingFileEmail($dateOfmovie, $movieID, $branchID, $packageID, $timeOfmovie);
            
            foreach ($userEmails as $userEmail) {
               $email->sendChangeTimeSlot($userEmail, $dateOfmovie1, $timeOfmovie1, $dateOfmovie, $timeOfmovie);
            }
            echo "<script>
                           ...
                           <div class="white_shd full margin_bottom_30">
                              ...
                              <div class="full price_table padding_infor_info">
                                 <div class="row">
                                    ...
                                    <!-- profile image -->
                                    <form action="admin_movieTimeSlot_details_edit.php" method="post" >
                                    <div class="col-lg-12">
