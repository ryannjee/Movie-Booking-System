			...
			<div class="container">
				<div class="header-area">
					...
					<div class="header-right">
						...
						<form action="searchMovie.php" method="POST" style="border-color:transparent; margin-left:15px;">
						<ul>
							<?php
			...
			<div class="container">
				<div class="row flexbox-center">
					<div class="col-lg-6 text-center text-lg-left">
						...
						<div class="col-lg-6 text-center text-lg-right" style="margin-bottom:35px;">
				...
				<hr />
					...
					<?php 
						...
						?>
							<div class="col-lg-4 col-md-4 col-sm-6">
								<div class="single-portfolio">
									<div class="single-portfolio-img" style="width:40%;">
										<img src="assets/img/Movie/Not found.png" alt="portfolio" />
										<div class="button-container">
											<form action="searchMovie.php" method="post">
												<button type="submit" class="button button-1" name="back">Back</button>
											</form>
										</div>
									</div>
									<div class="portfolio-content">
